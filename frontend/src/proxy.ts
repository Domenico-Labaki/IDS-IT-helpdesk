...
export function proxy(request: NextRequest) {
  ...
  if ((isMatch(pathname, "/admin") || isMatch(pathname, "/users") || isMatch(pathname, "/settings") || isMatch(pathname, "/activity-logs") || isMatch(pathname, "/monitoring")) && role !== "Admin") return NextResponse.redirect(new URL("/dashboard", request.url));
